...
<html>
  <head>
    ...
    <style>
      ...
      body {margin: 0;}
      /* ----------------------------------- TOPNAV STYLE */
      .topnav {overflow: hidden; background-color: #009879; color: white; font-size: 1.2rem;}
      /* ----------------------------------- */
  ...
  <body>
    <div class="topnav">
      <h3>MYSQL DATABASE (Temperature and Humidity)</h3>
    </div>
    
    <br>
    
    <h3 style="color: #009879;">ESP32_01 RECORD DATA TABLE</h3>
